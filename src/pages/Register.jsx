        ...
        return <div className="flex justify-center">
            <div className="flex flex-col absolute top-[30%] shadow-lg border-[2px]  p-5 w-[60%] rounded-lg">
                 ...
                 <div className="flex mt-3">
                    ...
                    name="last"
                    value={this.state.last}  onChange={this.handleChange} required/>
                 ...
                 <input className="border-[2px] rounded-lg w-[100%] p-2 outline-[#8a4af3] focus:border-[#8a4af3] ease-linear duration-200"
                    ...
                    value={this.state.password} onChange={this.handleChange} required/>
                     ...
                     <input className="border-[2px] rounded-lg w-[100%] p-2 outline-[#8a4af3] focus:border-[#8a4af3] ease-linear duration-20 ml-3"
                    Placeholder= 'Confirm' 
                    name="confirm"
