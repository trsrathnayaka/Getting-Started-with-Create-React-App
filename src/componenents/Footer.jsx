import { EmailOutlined, Facebook, GitHub, Instagram, LocalPhoneOutlined, LocationOnOutlined, Phone, Pinterest, Twitter } from "@mui/icons-material";
    ...
    <div className="flex items-center justify-around p-2 mobile:flex-col mobile:items-start">
      ...
      <div className="flex-1 flex flex-col p-2">
        <div className="flex m-3">
            ...
            <p className='pl-3'>State of Colombo</p>
        </div>
        <div className="flex m-3">
            <LocalPhoneOutlined className="text-[#521da8]"/>
            <p className='pl-3'>+94 12345678</p>
        </div>
        <div className="flex m-3">
            <EmailOutlined className="text-[#8a4af3]"/>
            <p className='pl-3'>Ranu@gmail.com</p>
        </div>
      </div>
    </div>
  );
